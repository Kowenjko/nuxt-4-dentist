<template>
  <div class="auth-page">
    <div class="auth-card">
      ...
      <p class="auth-sub">Увійдіть, щоб керувати записами</p>
      ...
      <form @submit.prevent="handleLogin" novalidate>
        <div class="auth-fg">
          <label class="auth-fl" for="login-email">Email</label>
          <input
            id="login-email"
            v-model="email"
            type="email"
        ...
        <div class="auth-fg">
          <label class="auth-fl" for="login-pass">Пароль</label>
          <input
            id="login-pass"
            v-model="password"
            type="password"
      ...
      <p class="auth-footer">Немає акаунту? <NuxtLink to="/register">Зареєструватись</NuxtLink></p>
    </div>
  </div>
</template>
